...
export default function Hero() {
  ...
  return (
    <section id="home" ref={ref} className="pt-20 sm:pt-32 pb-12 sm:pb-20 px-responsive bg-linear-to-b from-background via-background to-muted/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center py-responsive">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="space-y-4 sm:space-y-6" data-scroll>
              <div className="inline-block px-3 sm:px-4 py-2 bg-secondary/20 rounded-full border border-secondary/30" data-scroll>
                <span className="text-xs sm:text-sm font-medium text-primary">Welcome to my portfolio</span>
              </div>
              
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
                Full Stack
                <span className="bg-linear-to-r from-primary via-secondary to-primary bg-clip-text text-transparent"> Developer</span>
              </h1>
               <span className="text-xl sm:text-4xl font-semibold text-foreground">Kishan Kumar Thakur</span>
              

              <p className="text-sm sm:text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl" data-scroll>
                I craft exceptional digital experiences combining strategic design with robust engineering. Currently building innovative solutions at APEX, trained by Jeetain Mandal. Passionate about creating pixel-perfect interfaces and scalable applications.
              </p>
            </div>
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4" data-scroll>
              <a
                href="#projects"
            ...
            {/* Social Links */}
            <div className="flex gap-3 sm:gap-4 pt-4 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
              <a
                href="#"
            ...
            <div className="relative bg-linear-to-br from-primary/10 to-secondary/10 rounded-3xl p-6 sm:p-8 border border-secondary/30 backdrop-blur-sm hover-lift">
              <div className="space-y-4 sm:space-y-6">
                <div className="h-56 sm:h-64 bg-linear-to-br from-primary to-secondary rounded-2xl flex items-center justify-center text-5xl sm:text-6xl font-bold text-white/50 hover-scale">
                  <img src="/kishan.jpeg" alt="Kishan Kumar Thakur" className="w-full h-full object-cover rounded-2xl" style={{ objectPosition: 'center 20%' }} />
